...
function JR3D.compute_ρg!(ρg::CuArray, phase_ratios::PhaseRatios, rheology, args)
...
function JR3D.compute_melt_fraction!(ϕ::CuArray, phase_ratios::PhaseRatios, rheology, args)
