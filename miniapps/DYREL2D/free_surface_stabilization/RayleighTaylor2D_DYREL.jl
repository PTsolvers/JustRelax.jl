...
# The array backend_JP and the ParallelStencil backend_JP have to be the same one: `@zeros` allocates
...
function main(igg, nx, ny; figdir = "RayleighTaylor2D_DYREL")
    ...
    dyrel = DYREL(backend, stokes, rheology, phase_ratios, grid.di, dt; ϵ = 1.0e-6, γfact = 110)
