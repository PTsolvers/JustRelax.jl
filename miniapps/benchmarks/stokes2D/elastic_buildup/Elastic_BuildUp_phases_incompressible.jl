...
function main(igg; nx=64, ny=64, figdir="model_figs")
    ...
    τ_y     = 150e6           # yield stress. If do_DP=true, τ_y stand for the cohesion: c*cos(ϕ)
    ...
    η_reg   = 1e-14          # regularisation "viscosity"
    ...
    # stokes.V.Vy .= PTArray([-y*(εbg./2) for _ in 1:nx+2, y in xvi[2]])
