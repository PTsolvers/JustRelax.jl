...
if benchmark == :taylorGreen
    ...
    # include benchmark
    include("taylor_green/TaylorGreen_DYREL.jl")
...
elseif benchmark == :Burstedde
    ...
    # include benchmark
    include("burstedde/Burstedde_DYREL.jl")
...
elseif benchmark == :solvi
    ...
    # include benchmark
    include("solvi/SolVi_DYREL_3D.jl") # need to call this again if we switch from gpu <-/-> cpu
