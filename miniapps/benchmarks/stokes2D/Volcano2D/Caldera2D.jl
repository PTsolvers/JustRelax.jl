...
function main(li, origin, phases_GMG, T_GMG, igg; nx = 16, ny = 16, figdir = "figs2D", do_vtk = false, extension = 1.0e-15 * 0, cutoff_visc = (1.0e16, 1.0e23))
    ...
    # Rheology
    args0 = (; ϕ = ϕ_m, dϕdT, T = thermal.T, P = stokes.P, dt = Inf, perturbation_C = perturbation_C)
    ...
    while it < 100 #000 # run only for 5 Myrs
        ...
        args = (; ϕ = ϕ_m, dϕdT, T = thermal.T, P = stokes.P, dt = Inf, ΔT = thermal.ΔT, perturbation_C = perturbation_C)
