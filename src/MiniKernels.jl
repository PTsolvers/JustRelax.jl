...
Base.@propagate_inbounds @inline _av_xa(A::T, I::Vararg{Integer, 2}) where {T<:T2} = (center(A, I...) + right(A, I...)) * 0.5
Base.@propagate_inbounds @inline _av_ya(A::T, I::Vararg{Integer, 2}) where {T<:T2} = (center(A, I...) + front(A, I...)) * 0.5
Base.@propagate_inbounds @inline _av_xi(A::T, I::Vararg{Integer, 2}) where {T<:T2} = (front(A,  I...),   next(A, I...)) * 0.5
Base.@propagate_inbounds @inline _av_yi(A::T, I::Vararg{Integer, 2}) where {T<:T2} = (right(A,  I...),   next(A, I...)) * 0.5
# harmonic averages
