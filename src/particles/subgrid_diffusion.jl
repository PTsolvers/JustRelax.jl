...
function subgrid_characteristic_time!(
    subgrid_arrays, particles, dt₀, phases::PhaseRatio, rheology, thermal::ThermalArrays, stokes::StokesArrays, xci, di
)
    ni = size(stokes.P)
...
function subgrid_characteristic_time!(
    subgrid_arrays, particles, dt₀, phases::AbstractArray{Int, N}, rheology, thermal::ThermalArrays, stokes::StokesArrays, xci, di
) where N
    ni = size(stokes.P)
    @parallel (@idx ni) subgrid_characteristic_time!(
...
@parallel_indices (I...) function subgrid_characteristic_time!(dt₀, phase_ratios, rheology, T, P, di)
