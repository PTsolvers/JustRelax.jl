...
function init_rheologies(; is_plastic = true)
    ...
    diff_upper_crust            = DislocationCreep(A=5.07e-18, n=1.0, E=154e3, V=0.0,  r=0.0, R=8.3145)
    disl_lower_crust            = DislocationCreep(A=2.08e-23, n=3.2, E=238e3, V=0.0,  r=0.0, R=8.3145)
    diff_lower_crust            = DislocationCreep(A=2.08e-23, n=1.0, E=238e3, V=0.0,  r=0.0, R=8.3145)
    ...
    rheology = (
        ...
        SetMaterialParams(;
            Phase             = 4,
            Density           = PT_Density(; ρ0=3.3e3-10, β=β_sublithospheric_mantle, T0=0.0, α = 3e-5),
            HeatCapacity      = ConstantHeatCapacity(; cp=1.25e3),
            Conductivity      = K_mantle,
            RadioactiveHeat   = ConstantRadioactiveHeat(0.0),
