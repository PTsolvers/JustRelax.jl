...
function stress2grid!(stokes, τ_particles::JustRelax.StressParticles{backend}, xvi, xci, particles) where {backend}
    stress2grid!(stokes, normal_stress(τ_particles)..., shear_stress(τ_particles)..., xvi, xci, particles)
end
