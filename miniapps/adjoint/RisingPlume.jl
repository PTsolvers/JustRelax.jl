...
function sinking_block2D(igg; ar=2, ny=8, nx=ny*4, figdir="figs2D")
    ...
    rheology = (
        SetMaterialParams(;
            ...
            CompositeRheology = CompositeRheology((LinearViscous(; η = 3e20),)),
            Gravity           = ConstantGravity(; g=9.81),
        ),
        SetMaterialParams(;
            Name              = "Block",
            Phase             = 2,
            Density           = ConstantDensity(; ρ=3000.0),
    ...
    plottingInt = 10  # plotting interval
    t, it = 0.0, 0
    ...
    while it < 200
        ...
        # compute time step
        dt   = compute_dt(stokes, di) * 0.00001
