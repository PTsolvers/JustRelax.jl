...
function JR2D.stress2grid!(stokes, τ_particles::JustRelax.StressParticles{JustPIC.AMDGPUBackend}, xvi, xci, particles)
    stress2grid!(stokes, τ_particles, xvi, xci, particles)
    return nothing
end

function JR2D.rotate_stress!(τ_particles::JustRelax.StressParticles{JustPIC.AMDGPUBackend}, stokes, particles, xci, xvi, dt)
