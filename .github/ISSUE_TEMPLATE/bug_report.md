...
- [ ] Make sure you're reporting *a bug*; for general questions, please use the Discussion forum.
...
- [ ] Always ensure you're using the latest version of JustRelax.jl, and if possible, please
...
```
Paste your Manifest.toml here, or accurately describe which version of JustRelax.jl and its dependencies you are using.
```
...
Details on JustRelax.jl:

```
# please post the output of:
JustRelax.versioninfo()
```
