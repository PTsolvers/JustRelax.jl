...
Base.@propagate_inbounds @inline left(A::AbstractArray, i::I, j::I) where {I<:Integer} = A[
    i - 1, j
]
Base.@propagate_inbounds @inline right(A::AbstractArray, i::I, j::I) where {I<:Integer} = A[
    i + 1, j
]
Base.@propagate_inbounds @inline back(A::AbstractArray, i::I, j::I) where {I<:Integer} = A[
    i, j - 1
]
Base.@propagate_inbounds @inline front(A::AbstractArray, i::I, j::I) where {I<:Integer} = A[
    i, j + 1
]
Base.@propagate_inbounds @inline left(A::AbstractArray, i::I, j::I, k::I) where {I<:Integer} = A[
    i - 1, j, k
]
Base.@propagate_inbounds @inline right(A::AbstractArray, i::I, j::I, k::I) where {I<:Integer} = A[
    i + 1, j, k
]
Base.@propagate_inbounds @inline back(A::AbstractArray, i::I, j::I, k::I) where {I<:Integer} = A[
    i, j - 1, k
]
Base.@propagate_inbounds @inline front(A::AbstractArray, i::I, j::I, k::I) where {I<:Integer} = A[
    i, j + 1, k
]
Base.@propagate_inbounds @inline bot(A::AbstractArray, i::I, j::I, k::I) where {I<:Integer} = A[
    i, j, k - 1
]
Base.@propagate_inbounds @inline top(A::AbstractArray, i::I, j::I, k::I) where {I<:Integer} = A[
    i, j, k + 1
]
