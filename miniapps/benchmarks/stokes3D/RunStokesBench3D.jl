...
function runme(benchmark, nx, ny, nz; init_MPI = true, finalize_MPI = true)
    if benchmark == :TaylorGreen
        ...
        return f, L2_p, L2_vx, L2_vy, L2_vz
...
# run benchmark
f, = runme(benchmark, nx, ny, nz; init_MPI = init_MPI, finalize_MPI = finalize_MPI)