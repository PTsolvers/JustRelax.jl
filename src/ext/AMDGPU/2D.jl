...
function JR2D.compute_ρg!(ρg::ROCArray, phase_ratios::PhaseRatios, rheology, args)
...
function JR2D.compute_melt_fraction!(ϕ::ROCArray, phase_ratios::PhaseRatios, rheology, args)
