...
"""
save_marker_chain(fname::String, chain; conversion = 1.0e3, pvd::Union{Nothing, String} = nothing, t::Number = 0.0) = save_marker_chain(fname, Array(chain.cell_vertices ./ conversion), Array(chain.h_vertices) ./ conversion; pvd = pvd, t = t)

function save_marker_chain(
        fname::String, cell_vertices::AbstractVector{Float64}, h_vertices::AbstractVector{Float64};
