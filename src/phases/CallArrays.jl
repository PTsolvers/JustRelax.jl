...
@inline element(A::Union{Array,CuArray,ROCArray}, I::Vararg{Int,N}) where {N} = getindex(A, I...)
@inline function setelement!(A::Union{Array,CuArray,ROCArray}, x::Number, I::Vararg{Int,N}) where {N}
