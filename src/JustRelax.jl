module JustRelax
export Diffusion3DNonlinearSolvers

module Diffusion3DNonlinearSolvers


using ImplicitGlobalGrid
using ParallelStencil
using ParallelStencil.FiniteDifferences3D
# TODO how do we enforce that you cannot import this module if you are using conflicting ParallelStencil params?
# TODO can we avoid this @static?
USE_GPU=false  # TODO huge hack - how do we do this better?
@static if USE_GPU
    @init_parallel_stencil(CUDA, Float64, 3)
else
    @init_parallel_stencil(Threads, Float64, 3)
end
# Here, this should trigger the warning that we are initializing ParallelStencil twice,
# but if this were in a module, this would happen in a separate "parse time".

export solve!
export Diffusion3DNonlinearSolver
...
struct Diffusion3DNonlinearSolver
    nx
    ny
    nz
    b_width
...
function Diffusion3DNonlinearSolver(
    nx, ny, nz, b_width,       # 1
    me, dims, nprocs,          # 2
    ...
    return Diffusion3DNonlinearSolver(
        nx, ny, nz, b_width,
        CFL,
        Resc,
        tol,
...
function solve!(solver::Diffusion3DNonlinearSolver, H::Data.Array, first_solve = false)
...
end # module Diffusion3NonlinearSolvers
end # module JustRelax