...
include("RaisingBlob_rheology.jl")
...
function thermal_perturbation!(T, xc, yc, zc, r, xvi)

    @parallel_indices (i, j, k) function _thermal_perturbation!(T, xc, yc, zc, r, x, y, z)
    ...
    @parallel _thermal_perturbation!(T, xc, yc, zc, r, xvi...)
end
...
function main3D(igg; ar=1, nx=16, ny=16, nz=16, figdir="figs3D", do_vtk =false)
    ...
    thermal_perturbation!(thermal.T, xc_anomaly, yc_anomaly, zc_anomaly, r_anomaly, xvi)
