...
#     ::CPUBackendTrait, phase_ratios::PhaseRatios, particles, grid::Geometry, phases
# )
#     return _phase_ratios_center!(phase_ratios, particles, grid, phases)
# end

# function _phase_ratios_center!(
#     phase_ratios::PhaseRatios, particles, grid::Geometry, phases
# )
#     ni = size(phases)
