...
function JR3D.compute_ρg!(ρg::Union{CuArray, NTuple{N, CuArray}}, phase_ratios::JustPIC.PhaseRatios, rheology, args) where N
    return compute_ρg!(ρg, phase_ratios, rheology, args)
end
function JR3D.compute_ρg!(ρg::Union{CuArray, NTuple{N, CuArray}}, phase_ratios, rheology, args) where N
    return compute_ρg!(ρg, phase_ratios, rheology, args)
end
